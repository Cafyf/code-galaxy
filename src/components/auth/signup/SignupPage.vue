  ...
  <div class="container">
    <form @submit.prevent="validateInputs">
      ...
      <div class="input-control" :class="{ error: !passwordMatch && !stopValidate }">
        ...
        <div v-if="!passwordMatch && !stopValidate" class="error">{{ password2Error }}</div>
      </div>
